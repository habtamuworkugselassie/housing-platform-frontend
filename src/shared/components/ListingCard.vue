<template>
  <div
    class="relative bg-zinc-900 rounded-lg overflow-hidden transition-all cursor-pointer hover:bg-primary-900/20"
    :class="{
      'border border-white/10 hover:border-primary-400/60': !item.isSponsored,
