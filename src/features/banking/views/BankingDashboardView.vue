<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-white">
    ...
    <!-- Bank Info -->
    <div v-if="bank" class="bg-zinc-900 border border-white/10 rounded-lg p-6 mb-6 hover:border-primary-400 hover:bg-violet-950/10 transition-colors">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p class="mt-1">
            <span :class="[
              ...
              bank.status === 'APPROVED' ? 'bg-green-500/30 text-green-200' : 'bg-violet-950/30 text-white'
            ]">
              {{ bank.status }}
            </span>
          </p>
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-white">
            <a v-if="isDocumentUrl(bank.businessRegistration)" :href="mediaUrl(bank.businessRegistration)" target="_blank" rel="noopener" class="text-white hover:underline">View document</a>
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-white">
            <a v-if="isDocumentUrl(bank.license)" :href="mediaUrl(bank.license)" target="_blank" rel="noopener" class="text-white hover:underline">View document</a>
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-white">
            <a v-if="isDocumentUrl(bank.vatRegistration)" :href="mediaUrl(bank.vatRegistration)" target="_blank" rel="noopener" class="text-white hover:underline">View document</a>
        ...
        <div>
          ...
          <p class="mt-1 text-sm text-white">
            <a v-if="isDocumentUrl(bank.tinRegistration)" :href="mediaUrl(bank.tinRegistration)" target="_blank" rel="noopener" class="text-white hover:underline">View document</a>
    ...
    >
      <div class="relative mx-auto p-6 border border-white/10 w-full max-w-2xl rounded-lg bg-zinc-900 text-white">
        <div class="flex justify-between items-center mb-6">
          ...
          <button type="button" @click="showEditBankModal = false" class="text-gray-400 hover:text-primary-400">
        ...
        <form @submit.prevent="updateBank" class="space-y-4">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="bankForm.name" type="text" required class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-300">Registration number</label>
              <input v-model="bankForm.registrationNumber" type="text" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
            </div>
          </div>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-300">Business Registration</label>
              <input v-model="bankForm.businessRegistrationNumber" type="text" placeholder="Registration number" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <input v-model="bankForm.businessRegistration" type="text" placeholder="Document URL or upload below" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <div class="mt-1 flex items-center gap-2">
                ...
                <button type="button" :disabled="bankDocUploading.businessRegistration" class="text-sm px-2 py-1 border border-white/20 rounded text-gray-300 hover:border-primary-400 disabled:opacity-50" @click="bankDocInputRefs.businessRegistration?.click()">{{ bankDocUploading.businessRegistration ? 'Uploading…' : 'Upload document' }}</button>
                <a v-if="isDocumentUrl(bankForm.businessRegistration)" :href="mediaUrl(bankForm.businessRegistration)" target="_blank" rel="noopener" class="text-sm text-white hover:underline">View document</a>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-300">License</label>
              <input v-model="bankForm.licenseNumber" type="text" placeholder="License number" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <input v-model="bankForm.license" type="text" placeholder="Document URL or upload below" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <div class="mt-1 flex items-center gap-2">
                ...
                <button type="button" :disabled="bankDocUploading.license" class="text-sm px-2 py-1 border border-white/20 rounded text-gray-300 hover:border-primary-400 disabled:opacity-50" @click="bankDocInputRefs.license?.click()">{{ bankDocUploading.license ? 'Uploading…' : 'Upload document' }}</button>
                <a v-if="isDocumentUrl(bankForm.license)" :href="mediaUrl(bankForm.license)" target="_blank" rel="noopener" class="text-sm text-white hover:underline">View document</a>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-300">VAT Registration</label>
              <input v-model="bankForm.vatNumber" type="text" placeholder="VAT number" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <input v-model="bankForm.vatRegistration" type="text" placeholder="Document URL or upload below" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <div class="mt-1 flex items-center gap-2">
                ...
                <button type="button" :disabled="bankDocUploading.vatRegistration" class="text-sm px-2 py-1 border border-white/20 rounded text-gray-300 hover:border-primary-400 disabled:opacity-50" @click="bankDocInputRefs.vatRegistration?.click()">{{ bankDocUploading.vatRegistration ? 'Uploading…' : 'Upload document' }}</button>
                <a v-if="isDocumentUrl(bankForm.vatRegistration)" :href="mediaUrl(bankForm.vatRegistration)" target="_blank" rel="noopener" class="text-sm text-white hover:underline">View document</a>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-300">TIN Registration</label>
              <input v-model="bankForm.tinNumber" type="text" placeholder="TIN number" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <input v-model="bankForm.tinRegistration" type="text" placeholder="Document URL or upload below" class="mt-1 block w-full border border-white/20 bg-white/5 text-white placeholder-gray-400 rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              <div class="mt-1 flex items-center gap-2">
                ...
                <button type="button" :disabled="bankDocUploading.tinRegistration" class="text-sm px-2 py-1 border border-white/20 rounded text-gray-300 hover:border-primary-400 disabled:opacity-50" @click="bankDocInputRefs.tinRegistration?.click()">{{ bankDocUploading.tinRegistration ? 'Uploading…' : 'Upload document' }}</button>
                <a v-if="isDocumentUrl(bankForm.tinRegistration)" :href="mediaUrl(bankForm.tinRegistration)" target="_blank" rel="noopener" class="text-sm text-white hover:underline">View document</a>
              </div>
            </div>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300">Address</label>
            <input v-model="bankForm.address" type="text" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
          </div>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-300">City</label>
              <input v-model="bankForm.city" type="text" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-300">Country</label>
              <input v-model="bankForm.country" type="text" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <button type="button" class="text-sm text-white hover:text-primary-400" @click="bankForm.phoneNumbers.push({ countryCode: DEFAULT_COUNTRY_CODE, number: '' })">+ Add phone</button>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300">Email</label>
            <input v-model="bankForm.email" type="email" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300">Website</label>
            <input v-model="bankForm.website" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
          </div>
          <div class="sm:col-span-2 border-t border-white/10 pt-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input v-model="bankForm.facebookUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-400">{{ $t('organization.instagram') }}</label>
                <input v-model="bankForm.instagramUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-400">{{ $t('organization.linkedin') }}</label>
                <input v-model="bankForm.linkedinUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-400">{{ $t('organization.twitter') }}</label>
                <input v-model="bankForm.twitterUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              </div>
              <div class="sm:col-span-2">
                <label class="block text-xs font-medium text-gray-400">{{ $t('organization.youtube') }}</label>
                <input v-model="bankForm.youtubeUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400" />
              </div>
            </div>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300">Description</label>
            <textarea v-model="bankForm.description" rows="3" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-2 focus:ring-primary-400"></textarea>
          </div>
          <div class="flex justify-end gap-3 pt-4">
            ...
            <button type="submit" :disabled="bankFormSaving" class="px-4 py-2 bg-white text-black rounded-md hover:bg-primary-100 disabled:opacity-50">Save</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <!-- Quick Actions -->
    <div class="bg-zinc-900 border border-white/10 rounded-lg p-6 mb-8 hover:border-primary-400 hover:bg-violet-950/10 transition-colors">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <router-link
          ...
          :class="[
            ...
            bank ? 'border-white/10 hover:border-primary-400 hover:bg-violet-950/20' : 'border-white/10 opacity-50 cursor-not-allowed'
          ]"
        >
          <div class="flex-shrink-0 bg-violet-950/30 rounded-md p-3">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <router-link
          ...
          class="flex items-center p-4 border-2 border-white/10 rounded-lg hover:border-primary-400 hover:bg-violet-950/20 transition-colors cursor-pointer text-white"
        >
      ...
      <div class="p-6">
        ...
        <div v-else class="space-y-4">
          <div
            ...
            :key="product.id"
            class="flex items-center justify-between p-4 border border-white/10 rounded-lg hover:border-primary-400 hover:bg-violet-950/20 transition-colors"
          >
            <div>
            ...
            <span :class="[
              'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium',
              product.status === 'ACTIVE' ? 'bg-green-500/30 text-green-200' : 'bg-violet-950/30 text-white'
            ]">
              {{ product.status }}
            </span>
          </div>
