<template>
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white shadow rounded-lg p-8">
      <h2 class="text-2xl font-bold text-gray-900 mb-6">Create New Agent</h2>
      ...
      <form @submit.prevent="handleSubmit">
        <div class="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500"
              placeholder="Optional: Real estate license number"
            />
          </div>
        ...
        <div v-if="fieldErrors && fieldErrors.length > 0" class="mt-4 rounded-md bg-red-50 p-4">
          <div class="text-sm font-medium text-red-800 mb-2">Please fix the following errors:</div>
