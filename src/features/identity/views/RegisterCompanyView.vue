      ...
      <form @submit.prevent="handleSubmit">
          ...
          <div class="sm:col-span-2 border-t border-white/10 pt-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input id="fb" v-model="form.facebookUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-primary-400 focus:border-primary-400" />
              </div>
              <div>
                <label for="ig" class="block text-xs font-medium text-gray-400">{{ $t('organization.instagram') }}</label>
                <input id="ig" v-model="form.instagramUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-primary-400 focus:border-primary-400" />
              </div>
              <div>
                <label for="li" class="block text-xs font-medium text-gray-400">{{ $t('organization.linkedin') }}</label>
                <input id="li" v-model="form.linkedinUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-primary-400 focus:border-primary-400" />
              </div>
              <div>
                <label for="tw" class="block text-xs font-medium text-gray-400">{{ $t('organization.twitter') }}</label>
                <input id="tw" v-model="form.twitterUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-primary-400 focus:border-primary-400" />
              </div>
              <div class="sm:col-span-2">
                <label for="yt" class="block text-xs font-medium text-gray-400">{{ $t('organization.youtube') }}</label>
                <input id="yt" v-model="form.youtubeUrl" type="url" class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md py-2 px-3 focus:ring-primary-400 focus:border-primary-400" />
              </div>
            </div>
          </div>
        ...
        <div class="mt-6">
          <button
            type="submit"
            :disabled="loading"
            class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md text-sm font-medium text-black bg-white hover:bg-primary-100 focus:ring-2 focus:ring-primary-400 disabled:opacity-50 transition-colors"
          >
