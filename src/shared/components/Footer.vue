...
const socialLinks = [
  {
    label: 'Instagram',
    url: 'https://www.instagram.com/ethiobuildconnect?igsh=MTdiazV2d25wZzdjMQ%3D%3D&utm_source=qr',
    iconPath:
