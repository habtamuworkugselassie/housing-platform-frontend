        ...
        <div class="bg-zinc-900 border border-white/10 rounded-lg p-6 hover:border-black hover:bg-violet-950/10 transition-colors">
          ...
          <div class="grid grid-cols-2 gap-4">
            <router-link
              ...
              class="p-4 border-2 border-white/10 rounded-lg hover:border-black hover:bg-violet-950/20 transition-colors text-white"
            >
              <div class="text-center">
                <svg class="w-8 h-8 text-black mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
