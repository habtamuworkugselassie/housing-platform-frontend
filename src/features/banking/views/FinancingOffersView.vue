  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-white">
    ...
    <div v-if="!loading" class="grid grid-cols-1 gap-6">
      <div
        ...
        :key="offer.id"
        class="bg-zinc-900 border border-white/10 rounded-lg p-6 hover:border-primary-400 hover:bg-violet-950/20 transition-colors"
      >
          ...
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <span :class="[
                ...
                offer.status === 'PENDING_APPROVAL' ? 'bg-violet-950/30 text-white' :
          ...
          <form @submit.prevent="saveOffer" class="space-y-4">
            <div>
              ...
              <select
                ...
                required
                class="mt-1 block w-full border border-white/20 bg-white/5 text-white rounded-md focus:ring-2 focus:ring-primary-400 focus:border-primary-400 px-3 py-2"
              >
            ...
            <div v-if="linkType === 'property'">
              ...
              <div class="grid grid-cols-2 gap-2 mb-3">
                <input
                  ...
                  class="block w-full border border-white/20 bg-white/5 text-white rounded-md focus:ring-2 focus:ring-primary-400 focus:border-primary-400 px-3 py-2 text-sm"
              ...
              <div class="relative">
                ...
                <div v-else-if="propertySearchResults.length > 0" class="max-h-60 overflow-y-auto border border-white/20 bg-white/5 text-white rounded-md focus:ring-2 focus:ring-primary-400 focus:border-primary-400">
                  <div
                    ...
                    :class="[
                      ...
                      selectedProperties.includes(property.id) ? 'bg-violet-950/20 border-white/15' : ''
                    ]"
                  >
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
              ...
              <div v-if="selectedProperties.length > 0" class="mt-3 p-3 bg-violet-950/10 rounded-md border border-white/15">
            ...
            <div v-if="linkType === 'building'">
              ...
              <div class="relative">
                ...
                <div v-else-if="buildingSearchResults.length > 0" class="max-h-60 overflow-y-auto border border-white/20 bg-white/5 text-white rounded-md focus:ring-2 focus:ring-primary-400 focus:border-primary-400">
                  <div
                    ...
                    :class="[
                      'p-3 border-b border-white/10 hover:bg-violet-950/20 cursor-pointer transition-colors',
                      selectedBuildings.includes(building.id) ? 'bg-violet-950/20 border-white/15' : ''
                    ]"
                  >
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
              ...
              <div v-if="selectedBuildings.length > 0" class="mt-3 p-3 bg-violet-950/10 rounded-md border border-white/15">
                <p class="text-sm font-medium text-gray-400 mb-2">
