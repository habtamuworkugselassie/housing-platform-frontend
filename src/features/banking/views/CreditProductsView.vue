        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <span :class="[
                ...
                product.status === 'PENDING_APPROVAL' ? 'bg-violet-950/30 text-white' :
          ...
          <div class="ml-4 flex gap-2">
            <button
              ...
              class="px-3 py-1 text-sm text-white hover:text-primary-400 font-medium transition-colors"
            >
              Edit
            </button>
            <button
              @click="deleteProduct(product.id)"
              class="px-3 py-1 text-sm text-red-300 hover:text-primary-400 font-medium transition-colors"
            >
              Delete
            </button>
          </div>
              ...
              <div>
                ...
                <div class="mt-1 flex gap-2">
                  <input
                    ...
                    min="0"
                    required
                    class="flex-1 border border-white/20 bg-white/5 text-white rounded-md px-3 py-2 focus:ring-2 focus:ring-primary-400 focus:border-primary-400"
                  />
                  <select
                    v-model="productForm.currency"
                    required
                    class="w-32 border border-white/20 bg-white/5 text-white rounded-md px-3 py-2 focus:ring-2 focus:ring-primary-400 focus:border-primary-400"
                  >
