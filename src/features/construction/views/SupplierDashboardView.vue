    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="bg-zinc-900 border border-white/10 p-6 rounded-lg hover:border-primary-400 hover:bg-violet-950/10 transition-colors">
          ...
          <div class="bg-zinc-900 border border-white/10 p-6 rounded-lg hover:border-primary-400 hover:bg-violet-950/10 transition-colors">
            ...
            <p class="text-2xl font-bold text-white mt-2">{{ stats.pendingOrders }}</p>
          </div>
          <div class="bg-zinc-900 border border-white/10 p-6 rounded-lg hover:border-primary-400 hover:bg-violet-950/10 transition-colors">
        ...
        <div class="bg-zinc-900 border border-white/10 rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <router-link
              ...
              class="p-4 border border-white/10 rounded-lg hover:border-primary-400 hover:bg-violet-950/20 text-center text-white transition-colors"
            >
        ...
        <div class="bg-zinc-900 border border-white/10 rounded-lg p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <router-link
              to="/construction/orders"
              class="text-sm text-white hover:text-primary-400"
            >
              {{ $t('common.viewAll') }} →
            </router-link>
          </div>
          ...
          <div v-else class="space-y-3">
            <div
              ...
              class="border border-white/10 rounded-lg p-4 hover:border-primary-400 hover:bg-violet-950/10 transition-colors cursor-pointer"
            >
        ...
        <div class="bg-zinc-900 border border-white/10 rounded-lg p-6">
          ...
          <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div
              ...
              :key="item.id"
              class="border border-white/10 rounded-lg p-4 hover:border-primary-400 hover:bg-violet-950/10 transition-colors"
            >
